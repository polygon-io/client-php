...
/**
 * V2TicksStocksNbboTickerDateGet200ResponseAllOfResultsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class V2TicksStocksNbboTickerDateGet200ResponseAllOfResultsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_v2_ticks_stocks_nbbo__ticker___date__get_200_response_allOf_results_inner';
    ...
    protected static $openAPITypes = [
        ...
        'p' => 'float',
        's' => 'int',
        'x' => '\OpenAPI\Client\Model\V2TicksStocksNbboTickerDateGet200ResponseAllOfResultsInnerAllOfX',
        'c' => 'int[]',
        'i' => 'int[]',
        'p' => 'float',
        's' => 'int',
    ...
    */
     ...
     * Sets s
     *
     * @param int $s The ask size. This represents the number of round lot orders at the given ask price. The normal round lot size is 100 shares. An ask size of 2 means there are 200 shares available to purchase at the given ask price.
     *
     * @return self
     */
     ...
     * Gets x
     *
     * @return \OpenAPI\Client\Model\V2TicksStocksNbboTickerDateGet200ResponseAllOfResultsInnerAllOfX
     */
     ...
     * Sets x
     *
     * @param \OpenAPI\Client\Model\V2TicksStocksNbboTickerDateGet200ResponseAllOfResultsInnerAllOfX $x x
     *
     * @return self
     */
     ...
     * Sets i
     *
     * @param int[] $i The indicators. For more information, see our glossary of [Conditions and Indicators](https://polygon.io/glossary/us/stocks/conditions-indicators).
     *
     * @return self
     */
     ...
     * Sets s
     *
     * @param int $s The bid size. This represents the number of round lot orders at the given bid price. The normal round lot size is 100 shares. A bid size of 2 means there are 200 shares for purchase at the given bid price.
     *
     * @return self
     */
    public function setS($s)
