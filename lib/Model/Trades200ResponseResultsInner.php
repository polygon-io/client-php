...
/**
 * Trades200ResponseResultsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Trades200ResponseResultsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Trades_200_response_results_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('trf_id', $data ?? [], null);
        $this->setIfExists('trf_timestamp', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets exchange
     *
     * @param int $exchange The exchange ID. See <a href=\"https://polygon.io/docs/stocks/get_v3_reference_exchanges\" alt=\"Exchanges\">Exchanges</a> for Polygon.io's mapping of exchange IDs.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id The Trade ID which uniquely identifies a trade. These are unique per combination of ticker, exchange, and TRF. For example: A trade for AAPL executed on NYSE and a trade for AAPL executed on NASDAQ could potentially have the same Trade ID.
     *
     * @return self
     */
     ...
     *
     * @param int $participant_timestamp The nanosecond accuracy Participant/Exchange Unix Timestamp. This is the timestamp of when the trade was actually generated at the exchange.
     *
     * @return self
     */
     ...
     *
     * @param int $sequence_number The sequence number represents the sequence in which trade events happened. These are increasing and unique per ticker symbol, but will not always be sequential (e.g., 1, 2, 6, 9, 10, 11). Values reset after each trading session/day.
     *
     * @return self
     */
     ...
     * Sets tape
     *
     * @param int|null $tape There are 3 tapes which define which exchange the ticker is listed on. These are integers in our objects which represent the letter of the alphabet. Eg: 1 = A, 2 = B, 3 = C. * Tape A is NYSE listed securities * Tape B is NYSE ARCA / NYSE American * Tape C is NASDAQ
     *
     * @return self
     */
     ...
     * @return int|null
     */
    public function getTrfId()
    {
        return $this->container['trf_id'];
    }

    /**
     * Sets trf_id
     *
     * @param int|null $trf_id The ID for the Trade Reporting Facility where the trade took place.
     *
     * @return self
     */
    public function setTrfId($trf_id)
    {
        if (is_null($trf_id)) {
            throw new \InvalidArgumentException('non-nullable trf_id cannot be null');
        }
        $this->container['trf_id'] = $trf_id;
     ...
     * @return int|null
     */
    public function getTrfTimestamp()
    {
        return $this->container['trf_timestamp'];
    }

    /**
     * Sets trf_timestamp
     *
     * @param int|null $trf_timestamp The nanosecond accuracy TRF (Trade Reporting Facility) Unix Timestamp. This is the timestamp of when the trade reporting facility received this trade.
     *
     * @return self
     */
    public function setTrfTimestamp($trf_timestamp)
    {
        if (is_null($trf_timestamp)) {
            throw new \InvalidArgumentException('non-nullable trf_timestamp cannot be null');
        }
        $this->container['trf_timestamp'] = $trf_timestamp;
