...
/**
 * V2SnapshotLocaleUsMarketsStocksTickersGet200ResponseAllOfTickersInnerLastTrade Class Doc Comment
 *
 * @category Class
 ...
 */
class V2SnapshotLocaleUsMarketsStocksTickersGet200ResponseAllOfTickersInnerLastTrade implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_v2_snapshot_locale_us_markets_stocks_tickers_get_200_response_allOf_tickers_inner_lastTrade';
    ...
    */
     ...
     * Sets s
     *
     * @param int $s The size (volume) of the trade.
     *
     * @return self
     */
