...
/**
 * V2SnapshotLocaleGlobalMarketsForexTickersGet200ResponseAllOfTickersInnerMin Class Doc Comment
 *
 * @category Class
 ...
 */
class V2SnapshotLocaleGlobalMarketsForexTickersGet200ResponseAllOfTickersInnerMin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_v2_snapshot_locale_global_markets_forex_tickers_get_200_response_allOf_tickers_inner_min';
    ...
    */
     ...
     * Sets c
     *
     * @param float|null $c The close price for the symbol in the given time period.
     *
     * @return self
     */
     ...
     * Sets h
     *
     * @param float|null $h The highest price for the symbol in the given time period.
     *
     * @return self
     */
     ...
     * Sets l
     *
     * @param float|null $l The lowest price for the symbol in the given time period.
     *
     * @return self
     */
     ...
     * Sets o
     *
     * @param float|null $o The open price for the symbol in the given time period.
     *
     * @return self
     */
     ...
     * Sets t
     *
     * @param int|null $t The Unix Msec timestamp for the start of the aggregate window.
     *
     * @return self
     */
     ...
     * Sets v
     *
     * @param float|null $v The trading volume of the symbol in the given time period.
     *
     * @return self
     */
