...
/**
 * Snapshots200ResponseResultsInnerLastQuote Class Doc Comment
 *
 * @category Class
 ...
 */
class Snapshots200ResponseResultsInnerLastQuote implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Snapshots_200_response_results_inner_last_quote';
    ...
    */
     ...
     * Sets ask_exchange
     *
     * @param int|null $ask_exchange The ask side exchange ID. See <a href=\"https://polygon.io/docs/options/get_v3_reference_exchanges\" alt=\"Exchanges\">Exchanges</a> for Polygon.io's mapping of exchange IDs.
     *
     * @return self
     */
     ...
     * Sets bid_exchange
     *
     * @param int|null $bid_exchange The bid side exchange ID. See <a href=\"https://polygon.io/docs/options/get_v3_reference_exchanges\" alt=\"Exchanges\">Exchanges</a> for Polygon.io's mapping of exchange IDs.
     *
     * @return self
     */
     ...
     * Sets midpoint
     *
     * @param float|null $midpoint The average of the bid and ask price.
     *
     * @return self
     */
