...
/**
 * TradesCrypto200ResponseResultsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TradesCrypto200ResponseResultsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TradesCrypto_200_response_results_inner';
    ...
    */
     ...
     * Sets exchange
     *
     * @param int $exchange The exchange ID. See <a href=\"https://polygon.io/docs/crypto/get_v3_reference_exchanges\" alt=\"Exchanges\">Exchanges</a> for Polygon.io's mapping of exchange IDs.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id The Trade ID which uniquely identifies a trade on the exchange that the trade happened on.
     *
     * @return self
     */
     ...
     *
     * @param int|null $participant_timestamp The nanosecond Exchange Unix Timestamp. This is the timestamp of when the trade was generated at the exchange.
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param float $price The price of the trade in the base currency of the crypto pair.
     *
     * @return self
     */
