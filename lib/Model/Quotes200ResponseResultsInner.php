...
/**
 * Quotes200ResponseResultsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Quotes200ResponseResultsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Quotes_200_response_results_inner';
    ...
    */
     ...
     * Sets indicators
     *
     * @param int[]|null $indicators A list of indicator codes.
     *
     * @return self
     */
     ...
     *
     * @param int $participant_timestamp The nanosecond accuracy Participant/Exchange Unix Timestamp. This is the timestamp of when the quote was actually generated at the exchange.
     *
     * @return self
     */
     ...
     *
     * @param int $sequence_number The sequence number represents the sequence in which quote events happened. These are increasing and unique per ticker symbol, but will not always be sequential (e.g., 1, 2, 6, 9, 10, 11). Values reset after each trading session/day.
     *
     * @return self
     */
     ...
     * Sets trf_timestamp
     *
     * @param int|null $trf_timestamp The nanosecond accuracy TRF (Trade Reporting Facility) Unix Timestamp. This is the timestamp of when the trade reporting facility received this quote.
     *
     * @return self
     */
