...
/**
 * SnapshotSummary200ResponseResultsInnerOptions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SnapshotSummary200ResponseResultsInnerOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SnapshotSummary_200_response_results_inner_options';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['underlying_ticker'] === null) {
            $invalidProperties[] = "'underlying_ticker' can't be null";
        }
     ...
     *
     * @param string $underlying_ticker The ticker for the option contract.
     *
     * @return self
     */
